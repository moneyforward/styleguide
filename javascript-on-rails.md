...
先頭セクションの [JavaScript を使った機能の開発手順](#javascript-を使った機能の開発手順) を読み、
可能な限りその手順を守ってください。  
...
いち URL アクセスによって実行されるコード範囲や副作用の影響を絞ることを目的としています。
...
つまり、保守性に難があるコードで、本ガイドライン下では禁止に入る書き方です。  
